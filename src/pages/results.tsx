...
import { AsyncReturnType } from "@mon/utils/ts-bs";
  ...
  return (
    <div className="flex flex-col items-center">
      ...
      <div className="flex flex-col w-full max-w-2xl border">
        {props.pokemon
          .sort(
            (a: PokemonQueryResult[number], b: PokemonQueryResult[number]) => {
              const difference =
          ...
          .map((currentPokemon: PokemonQueryResult[number], index: number) => {
            return (
              <PokemonListing
